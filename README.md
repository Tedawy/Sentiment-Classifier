# Python FunctionsFilesDictionaries FinalCourseProject
...
#### 2. def get_pos(tweets)
which takes one parameter, a string which represents one or more sentences, and calculates how many words in the string are considered positive words. Use the list, positive_words to determine what words will count as positive. The function should return a positive integer - how many occurrences there are of positive words in the text.

#### 3. def get_neg(tweets)
...
## Scatterplot
<img src="image/scatterplot.png"  width="300"/>
